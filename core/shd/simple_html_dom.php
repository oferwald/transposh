...
function file_get_html_transposh() {
    $dom = new simple_html_dom_transposh;
    $args = func_get_args();
...
function str_get_html_transposh($str, $lowercase = true) {
    $dom = new simple_html_dom_transposh;
...
function dump_html_tree_transposh($node, $show_attr = true, $deep = 0) {
    ...
    foreach ($node->nodes as $c)
        dump_html_tree_transposh($c, $show_attr, $deep + 1);
}
...
class simple_html_dom_node_transposh {
    ...
    function dump($show_attr = true) {
        dump_html_tree_transposh($this, $show_attr);
    }
...
// -----------------------------------------------------------------------------
class simple_html_dom_transposh {
