...
(function ($) { // closure
    ...
    function google_trans (to_trans,from, lang, callback) {
	$.ajax({
	    url: 'http://ajax.googleapis.com/ajax/services/language/translate' +
	    '?v=1.0&q=' + to_trans + '&langpair=%7C'+lang/*+'&callback=?'*/,
	    dataType: "jsonp",
	    success: callback
	});
    ...
    function ms_trans (to_trans, from, binglang, callback) {
	$.ajax({
	    url: "http://api.microsofttranslator.com/V2/Ajax.svc/Translate?appId=FACA8E2DF8DCCECE0DC311C6E57DA98EFEFA9BC6&to=" + binglang + "&text=" + to_trans,
	    dataType: "jsonp",
	    jsonp: "oncomplete",
	    success: callback	    
	});
	...
	var auto_translated_phrases = [], binglang = to_binglang(t_jp.lang);
